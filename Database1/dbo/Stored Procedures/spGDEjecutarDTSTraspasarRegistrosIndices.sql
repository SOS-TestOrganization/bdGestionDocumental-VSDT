...
/*---------------------------------------------------------------------------------
* Metodo o PRG 	         : spGDEjecutarDTSTraspasarRegistrosIndices 
...
*---------------------------------------------------------------------------------
*/
--Exec[spGDEjecutarDTSTraspasarRegistrosIndices] 11296
CREATE Procedure [dbo].[spGDEjecutarDTSTraspasarRegistrosIndices]
...
Begin
	...
	Exec		bdSeguridad.dbo.SpEjecutaDTS_cmdshell_Catalogo 
				@Server,
				@PkgName = '\SSISDB\GestionDocumental\SSISIndicesImagenesDigitalizadas01\TraspasarRegistrosIndices.dtsx',
				@ServerUser		= Null,		
				@ServerPWD		= Null,		
...
GO
GRANT EXECUTE
    ON OBJECT::[dbo].[spGDEjecutarDTSTraspasarRegistrosIndices] TO [GestionDocumental]
    AS [dbo];


GO
GRANT EXECUTE
    ON OBJECT::[dbo].[spGDEjecutarDTSTraspasarRegistrosIndices] TO [Administrador Gestion Documental]
    AS [dbo];


GO
GRANT EXECUTE
    ON OBJECT::[dbo].[spGDEjecutarDTSTraspasarRegistrosIndices] TO [Administrador Digitalizadores Gestion Documental ]
    AS [dbo];


GO
GRANT EXECUTE
    ON OBJECT::[dbo].[spGDEjecutarDTSTraspasarRegistrosIndices] TO [websos]
    AS [dbo];


GO
GRANT EXECUTE
    ON OBJECT::[dbo].[spGDEjecutarDTSTraspasarRegistrosIndices] TO [visosservice_role]
    AS [dbo];

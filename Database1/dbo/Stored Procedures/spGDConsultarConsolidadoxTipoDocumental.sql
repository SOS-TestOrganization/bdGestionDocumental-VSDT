...
/*---------------------------------------------------------------------------------    
* Metodo o PRG    :  spGDConsultarConsolidadoxTipoDocumental  
* Desarrollado por   :  <\A   Ing. Cesar García  A\>    
* Descripcion    :  <\D        D\>    
* Observaciones       :  <\O    O\>    
* Parametros    :  <\P      P\>    
* Variables     :  <\V      V\>    
* Fecha Creacion   :  <\FC 20090611        FC\>    
*      
*---------------------------------------------------------------------------------    
...
*---------------------------------------------------------------------------------*/    
CREATE Procedure [dbo].[spGDConsultarConsolidadoxTipoDocumental]
...
Set		@ldFechaInicioDigitalizacion	=	'2009/07/01'
Set		@ldFechaFinDigitalizacion		=	'2009/07/07'
Set		@ldFechaInicioCarga				=	'2009/07/01'
Set		@ldFechaFinCarga				=	'2009/07/07'
*/
...
--select @lnConsecutivoTipoDocumental , @lnConsecutivoTipoDocumento	, @ldFechaInicioDigitalizacion  , @ldFechaFinDigitalizacion		, @lcError						, @ldFechaInicioCarga			, @ldFechaFinCarga		
...
If @lnConsecutivoTipoDocumental = 2
	Begin
		...
		Union
		Select			a. cnsctvo_cdgo_dcmnto,		b.dscrpcn_dgtlzdr,			d.dscrpcn_tpo_dcmnto,
						Null,						space(30) as blsa,			space(23) as nmro_idntfccn,
						space(23) As nmro_ntfccn,	space(23)  as nmro_acta,	a.nmro_imgns,
						space(3) As sde,			a.fcha_dgtlzcn
		From			dbo.tbDocumentosDigitalizados				a
		Inner Join		dbo.tbDigitalizadores						b On (a.cnsctvo_cdgo_dgtlzdr  = b.cnsctvo_cdgo_dgtlzdr)
		Inner Join		dbo.tbTiposDocumento						d On (a.cnsctvo_cdgo_tpo_dcmntl = d.cnsctvo_cdgo_tpo_dcmnto)
		Where			(a.cnsctvo_cdgo_tpo_dcmntl  =   @lnConsecutivoTipoDocumento  Or @lnConsecutivoTipoDocumento Is Null)
		And				a.cnsctvo_cdgo_dgtlzdr	=	5
		And				a.estdo_rgstro			=	'S'
...
If @lnConsecutivoTipoDocumental = 4
	Begin
		...
		(	cnsctvo_cdgo_dcmnto		udtConsecutivo,
			...
			blsa					udtDescripcion,
			nmro_idntfccn			udtNumeroIdentificacion,
			nmro_fctra				Char(20),--udtNumeroFormulario,
...
GO
GRANT EXECUTE
    ON OBJECT::[dbo].[spGDConsultarConsolidadoxTipoDocumental] TO [GestionDocumental]
    AS [dbo];


GO
GRANT EXECUTE
    ON OBJECT::[dbo].[spGDConsultarConsolidadoxTipoDocumental] TO [Administrador Gestion Documental]
    AS [dbo];


GO
GRANT EXECUTE
    ON OBJECT::[dbo].[spGDConsultarConsolidadoxTipoDocumental] TO [Administrador Digitalizadores Gestion Documental ]
    AS [dbo];


GO
GRANT EXECUTE
    ON OBJECT::[dbo].[spGDConsultarConsolidadoxTipoDocumental] TO [websos]
    AS [dbo];


GO
GRANT EXECUTE
    ON OBJECT::[dbo].[spGDConsultarConsolidadoxTipoDocumental] TO [visosservice_role]
    AS [dbo];

...
*---------------------------------------------------------------------------------*/
--exec spGDConsultaConsolidadoDocumentosNotificacion '2424918', null, null, null, null, null, null, null, null
--exec spGDConsultaConsolidadoDocumentosNotificacion null, '531673', null, null, null, null, null, null, null
--exec spGDConsultaConsolidadoDocumentosNotificacion null, null, '222743', null, null, null, null, null, null
CREATE PROCEDURE [dbo].[spGDConsultaConsolidadoDocumentosNotificacion] 
...
BEGIN
	...
	/*
	Declare	@usro	Varchar(50)
	Set		@usro	=	current_user

	Insert Into	tempdb..tmpLog
	Values		(@usro)
	*/
...
GO
GRANT EXECUTE
    ON OBJECT::[dbo].[spGDConsultaConsolidadoDocumentosNotificacion] TO [GestionDocumental]
    AS [dbo];


GO
GRANT EXECUTE
    ON OBJECT::[dbo].[spGDConsultaConsolidadoDocumentosNotificacion] TO [Administrador Gestion Documental]
    AS [dbo];


GO
GRANT EXECUTE
    ON OBJECT::[dbo].[spGDConsultaConsolidadoDocumentosNotificacion] TO [Administrador Digitalizadores Gestion Documental ]
    AS [dbo];


GO
GRANT EXECUTE
    ON OBJECT::[dbo].[spGDConsultaConsolidadoDocumentosNotificacion] TO [websos]
    AS [dbo];


GO
GRANT EXECUTE
    ON OBJECT::[dbo].[spGDConsultaConsolidadoDocumentosNotificacion] TO [visosservice_role]
    AS [dbo];

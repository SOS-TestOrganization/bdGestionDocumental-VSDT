...
Execute dbo.spGDGenerarTemporalRegistrosIndicesAgrupados_borrar2 @lnIdentificadorUnico = '111',@lnTipoDocumento = ?,@agrpdo = 'S', @prcso_crga = ?
select * from tbRegistrosArchivosIndices
*/

CREATE PROCEDURE [dbo].[spGDGenerarTemporalRegistrosIndicesAgrupados_borrar2]
(
...
print @queryInsert
print @dclre_prmtrs
print @fcha_crga_inco
print @fcha_crga_fn
print @lnIdentificadorUnico
print @lnTipoDocumento

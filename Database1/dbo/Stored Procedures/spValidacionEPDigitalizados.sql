...
*----------------------------------------------------------------------------------------------------------------------------
*/
CREATE procedure [dbo].[spValidacionEPDigitalizados]
...
left outer join		bdsisalud.dbo.tbafiliadosmarcados					b	On	c.cnsctvo_ntfccn				=	b.cnsctvo_ntfccn
																			...
																			And b.cnsctvo_cdgo_clsfccn_evnto	=	5
...
And					a.cnsctvo_cdgo_tpo_dcmnto		=	17 --EP
...
GO
GRANT EXECUTE
    ON OBJECT::[dbo].[spValidacionEPDigitalizados] TO [GestionDocumental]
    AS [dbo];


GO
GRANT EXECUTE
    ON OBJECT::[dbo].[spValidacionEPDigitalizados] TO [websos]
    AS [dbo];


GO
GRANT EXECUTE
    ON OBJECT::[dbo].[spValidacionEPDigitalizados] TO [visosservice_role]
    AS [dbo];

...
CREATE procedure [dbo].[spValidacionATEPDigitalizados]
...
left outer join		bdsisalud.dbo.tbafiliadosmarcados					b	On	c.cnsctvo_ntfccn=b.cnsctvo_ntfccn
																			And c.cnsctvo_cdgo_ofcna=b.cnsctvo_cdgo_ofcna AND b.cnsctvo_cdgo_clsfccn_evnto in (4,5)
...
And					a.cnsctvo_cdgo_tpo_dcmnto		=	9 --atep
...
GO
GRANT EXECUTE
    ON OBJECT::[dbo].[spValidacionATEPDigitalizados] TO [GestionDocumental]
    AS [dbo];


GO
GRANT EXECUTE
    ON OBJECT::[dbo].[spValidacionATEPDigitalizados] TO [Administrador Gestion Documental]
    AS [dbo];


GO
GRANT EXECUTE
    ON OBJECT::[dbo].[spValidacionATEPDigitalizados] TO [Administrador Digitalizadores Gestion Documental ]
    AS [dbo];


GO
GRANT EXECUTE
    ON OBJECT::[dbo].[spValidacionATEPDigitalizados] TO [websos]
    AS [dbo];


GO
GRANT EXECUTE
    ON OBJECT::[dbo].[spValidacionATEPDigitalizados] TO [visosservice_role]
    AS [dbo];

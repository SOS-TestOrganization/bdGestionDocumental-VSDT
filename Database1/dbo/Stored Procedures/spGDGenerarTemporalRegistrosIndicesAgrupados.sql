...
dbo.spGDGenerarTemporalRegistrosIndicesAgrupados_Borrar 'cccd',4,'S',500
select * from tbRegistrosArchivosIndices
*/

CREATE PROCEDURE [dbo].[spGDGenerarTemporalRegistrosIndicesAgrupados]
(
...
DBCC CHECKIDENT (tbTemporalRegistrosIndicesAgrupados, RESEED, 0)
...
GO
GRANT EXECUTE
    ON OBJECT::[dbo].[spGDGenerarTemporalRegistrosIndicesAgrupados] TO [GestionDocumental]
    AS [dbo];


GO
GRANT EXECUTE
    ON OBJECT::[dbo].[spGDGenerarTemporalRegistrosIndicesAgrupados] TO [Administrador Gestion Documental]
    AS [dbo];


GO
GRANT EXECUTE
    ON OBJECT::[dbo].[spGDGenerarTemporalRegistrosIndicesAgrupados] TO [Consultor Gestion Documental]
    AS [dbo];


GO
GRANT EXECUTE
    ON OBJECT::[dbo].[spGDGenerarTemporalRegistrosIndicesAgrupados] TO [Gestion Documental Web]
    AS [dbo];


GO
GRANT EXECUTE
    ON OBJECT::[dbo].[spGDGenerarTemporalRegistrosIndicesAgrupados] TO [Liquidador Recobros]
    AS [dbo];


GO
GRANT EXECUTE
    ON OBJECT::[dbo].[spGDGenerarTemporalRegistrosIndicesAgrupados] TO [Coordinador Parametros Recobro]
    AS [dbo];


GO
GRANT EXECUTE
    ON OBJECT::[dbo].[spGDGenerarTemporalRegistrosIndicesAgrupados] TO [websos]
    AS [dbo];


GO
GRANT EXECUTE
    ON OBJECT::[dbo].[spGDGenerarTemporalRegistrosIndicesAgrupados] TO [visosservice_role]
    AS [dbo];

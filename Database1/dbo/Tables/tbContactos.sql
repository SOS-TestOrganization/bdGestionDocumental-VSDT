...
GO
GRANT DELETE
    ON OBJECT::[dbo].[tbContactos] TO [GestionDocumental]
    AS [dbo];
...
GO
GRANT SELECT
    ON OBJECT::[dbo].[tbContactos] TO [Consultor Gestion Documental]
    AS [dbo];


GO
GRANT SELECT
    ON OBJECT::[dbo].[tbContactos] TO [Administrador Servicio al Cliente]
    AS [dbo];


GO
GRANT SELECT
    ON OBJECT::[dbo].[tbContactos] TO [Unibase]
    AS [dbo];
